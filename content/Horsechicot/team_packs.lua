...
SMODS.Booster {
    ...
    config = { choose = 1, extra = 3, ppu_team = "[RANDOM TEAM]" },
    discovered = true,
    cost = 4,
    weight = 0.4,
    kind = 'hpot_team',
    group_key = 'k_hpot_team_pack',
    ppu_artist = {'lord.ruby'},
    ppu_coder = {'lord.ruby'},
...
SMODS.Booster {
    ...
    config = { choose = 1, extra = 5, ppu_team = "[RANDOM TEAM]" },
    discovered = true,
    cost = 6,
    weight = 0.3,
    kind = 'hpot_team',
...
SMODS.Booster {
    ...
    config = { choose = 2, extra = 5, ppu_team = "[RANDOM TEAM]" },
    discovered = true,
    cost = 8,
    weight = 0.2,
    kind = 'hpot_team',
...
SMODS.Booster {
    ...
    config = { choose = 3, extra = 7, ppu_team = "[RANDOM TEAM]" },
    discovered = true,
    cost = 4,
    weight = 0.4,
    kind = 'hpot_team',
